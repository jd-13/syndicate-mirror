...
EnvelopeViewer::EnvelopeViewer(EnvelopeFollowerWrapper& envelope) : _envelope(envelope) {
...
ModulationBarEnvelope::ModulationBarEnvelope(EnvelopeFollowerWrapper& envelope) : _envelope(envelope) {
